...
| NETSTACK2-002 Buffer / Packet I/O contracts | planned |
| NETSTACK2-003 BPF/XDP packet I/O backend | planned |
| NETSTACK2-004 Dispatcher / StackShard | planned |
| NETSTACK2-API-FREEZE-001 | pending |
| P3A / P3B / P3C (IP layer, TCP state machine, interop) | planned |

See `bench/README.md` for the P0 baseline measurement protocol.
