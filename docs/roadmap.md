...
| P4 | **In progress** | OpenPPP2 集成。P4-1 RuntimeDependencies 注入 + P4-3 IClock 替换已完成（34/34 三套构建全绿），新增 `clock.h`、`events.h`、`runtime_deps.h` 三个公共头。详见 `docs/plans/P4_OPENPPP2_INTEGRATION_PLAN.md`。 |
