...
| P3C | **In progress** | P3C-01 DeliveryRateSampler + CongestionController 接口 + AIMD 适配完成，commit `aa9332e`。P3C-02 BBRv1 状态机测试完成，TCP congestion 43/43、全量 31/31 三套构建全绿。Pacing 和 fragment 接线待 P3C-03/04 |
...
| P3C-02 (BBRv1 state-machine tests) | `pending` | 无 |
